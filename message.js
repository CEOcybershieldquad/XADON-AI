...
class PluginLoader {
 ...
 'ai': '🤖 𝐗𝐀𝐃𝐎𝐍 𝐀𝐈 MENU',
 'downloader': '📥 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 MENU',
 'fun': '🎮 𝐅𝐔𝐍 MENU',
 'general': '⚡ 𝐆𝐄𝐍𝐄𝐑𝐀𝐋 MENU✪',
 'group': '👥 𝐆𝐑𝐎𝐔𝐏 MENU',
 'owner': '👑 𝐎𝐖𝐍𝐄𝐑 MENU',
 'other': '📦 𝐎𝐓𝐇𝐄𝐑 MENU',
 'tools': '🛠️ 𝐓𝐎𝐎𝐋𝐒 MENU',
 'defense': '🛡️ 𝐃𝐄𝐅𝐄𝐍𝐒𝐄 MENU',
 'media': '🗣️. 𝐌𝐄𝐃𝐈𝐀 𝐌𝐄𝐍𝐔',
 'xadon': '🚀 𝐂𝐒𝐐 𝐒𝐏𝐄𝐂𝐈𝐀𝐋 MENU',
 'documents': '📝 DOCUMENTS MENU',
 'antis': '🛡️ 𝐀𝐍𝐓𝐈𝐒 𝐌𝐄𝐍𝐔🛡️',
 'utils': '🌀 𝐔𝐓𝐈𝐋𝐈𝐓𝐘 𝐌𝐄𝐍𝐔',
 'audio': '🎤 𝐀𝐔𝐃𝐈𝐎 𝐌𝐄𝐍𝐔',
 'timer': '⏰ 𝐓𝐈𝐌𝐄𝐑 𝐌𝐄𝐍𝐔',
 'anime': '🎉 𝐀𝐍𝐈𝐌𝐄 𝐌𝐄𝐍𝐔',
 'generate': '👨‍💻 𝐗𝐀𝐃𝐎𝐍 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐈𝐎𝐍 𝐌𝐄𝐍𝐔',
 'vpn': '🦅 XADON NUMBERS MENU',
 'economy': '♊ ECONOMY MENU',
 'overlays': '💥 OVERLAYS MENU',
 'text': '🎉 TEXT MAKER',
 'privacy': '🔏 PRIVACY MENU',
 'utility': '🚙 PRO UTILITY MENU',
 'moderation': '🔒 MODERATION MENU',
...
module.exports = sock = async (sock, m, chatUpdate, store) => {
 ...
 const isOwner = m.sender === sock.user.id;
m.isOwner = isOwner;
