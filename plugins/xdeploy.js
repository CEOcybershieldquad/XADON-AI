module.exports = {
 ...
 `1. Go to your panel\n> ֎`,
 `2. Go to "Files" tab\n> ֎`,
 `3. Click on new file,Then paste the index.js code, create new file name it index.js and save content\n> ֎`,
 `4. Save this file as index.js as instructed above it may not be clear here get it from the group admin\n\n📂 FILE CONTENT: PART 1/${chunks.length}\n> ֎`,
 ...chunks.map((c, i) => `PART ${i + 1}/${chunks.length}:\n\`\`\`${c}\`\`\``),
 `5. Then go to "Console" and click Start\n> ֎`,
 `6. Wait a little till you are asked to put your phone number\n> ֎`,
 `7. Put it\nE.g 2345858686986\n> ֎`,
 `8. It will bring a pair code\n> ֎`,
 `9. Cram that pair code\n> ֎`,
 `10. Go to WhatsApp, tap the 3 dots up\nClick "Linked devices"\n> ֎`,
 `11. Tap "Link a device" > "Link with phone number instead"\n> ֎`,
 `12. Insert the code and wait till it logs in\n> ֎`,
 `13. If you are done you will be sent a message to your DM. That means you are successful ✅\n> ֎`
 ];
