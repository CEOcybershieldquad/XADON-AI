module.exports = {
    ...
    description: 'Get the current shareable group invite link (with preview)',
    category: 'group',
    usage: '.linkgc',
    ...
    execute: async (sock, m, { reply }) => {
        ...
        try {
            ...
            const text = `✪ *Group Invite Link* 🚀\n\n` +
                         ...
                         `Description: ${desc}\n\n` +
                         `→ ${link}\n\n` +
                         `*✨Tap the group link to join directly you can read the group info for more information ✨*`;
