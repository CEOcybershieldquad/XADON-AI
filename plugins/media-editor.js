...
module.exports = {
    ...
    description: 'Edit replied image: upscale, blur, pixelate, glow, red tint, gray, invert',
    category: 'tools',
    ...
    execute: async (sock, m, { args, reply }) => {
        ...
        if (!mtype.includes('image')) {
            return reply('𖣘 Reply to an *image* (not video/sticker/doc)');
        }
        ...
        try {
            ...
            switch (cmd) {
                ...
                default:
                    return reply('Unknown edit command. Use: .blur | .upscale | .pixel <num> | .glow | .red | .gray | .invert');
            }
